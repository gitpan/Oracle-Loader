# This Makefile is for the Oracle::Loader extension to perl.
#
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  Loader.pm $(INST_MAN3DIR)/Oracle::Loader.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Oracle/Loader.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Loader.pm $(INST_LIB)/Oracle/Loader.pm 
	$(NOECHO) $(TOUCH) $@
